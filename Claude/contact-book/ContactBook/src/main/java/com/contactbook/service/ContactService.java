 ...
 *
 * <p>Holds the CRUD business rules and keeps the web layer free of storage
 * concerns. The server owns contact ids: {@link #create(Contact)} assigns a new
 * id and updates always preserve the id from the path.</p>
 */
@Service
