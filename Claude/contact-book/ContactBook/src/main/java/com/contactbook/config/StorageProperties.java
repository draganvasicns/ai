 ...
 *
 * @param type which storage implementation to activate (e.g. {@code file}). Reserved for future use
 *     when more than one implementation exists.
 * @param file path to the JSON file used by the file-based storage.
 */
@ConfigurationProperties(prefix = "contactbook.storage")
public record StorageProperties(String type, String file) {
