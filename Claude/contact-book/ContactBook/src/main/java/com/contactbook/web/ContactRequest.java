...
/**
 * Payload accepted by create/update endpoints. Validated by Bean Validation before it reaches the
 * service layer. The id is never accepted from the client; it is owned by the server.
 */
