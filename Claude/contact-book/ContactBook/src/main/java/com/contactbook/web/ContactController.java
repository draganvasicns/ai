 ...
 * </pre>
 *
 * <p>Request bodies are validated ({@link ContactRequest}); a missing contact
 * yields 404 and a validation failure yields 400 (see
 * {@code com.contactbook.web.GlobalExceptionHandler}).</p>
 */
@RestController
