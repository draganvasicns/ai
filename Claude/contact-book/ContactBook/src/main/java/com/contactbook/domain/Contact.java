 ...
 *
 * <p>This is the core domain type shared by the web, service, and repository
 * layers. It is an immutable value: the {@code id} is owned by the server and is
 * {@code null} for a contact that has not yet been persisted (see
 * {@code com.contactbook.web.ContactRequest#toContact()}).</p>
 *
 * <p>The {@code emails} and {@code phoneNumbers} lists are normalised to
 * non-null, unmodifiable lists so callers never have to null-check or worry about
 * later mutation.</p>
 *
